...
static const Rule rules[] = {
    ...
    {"nsxiv", NULL, NULL, 0, 0, 0, 0, -1, 0},
    {"sxiv", NULL, NULL, 0, 0, 0, 0, -1, 0},
    {"feh", NULL, NULL, 0, 0, 0, 0, -1, 0},
...
static const Key keys[] = {
    ...
    {0, XK_Print, spawn,
     SHCMD("scrot ~/Pictures/screenshots/%Y%m%d_%H%M%S.png && notify-send "
           "'Screenshot taken'")},
    {ShiftMask, XK_Print, spawn,
     SHCMD("scrot -s ~/Pictures/screenshots/%Y%m%d_%H%M%S.png && notify-send "
           "'Screenshot taken'")},
